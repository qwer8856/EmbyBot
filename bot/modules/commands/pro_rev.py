...
# 增加白名单
@bot.on_message(filters.command('prouser', prefixes=prefixes) & filters.user(owner))
...
# 减少白名单
@bot.on_message(filters.command('revuser', prefixes=prefixes) & filters.user(owner))
